...
| [Claude plugin](claude-plugin.md) | Native Claude Code/Cowork installation, validation, and submission |
| [ChatGPT submission](chatgpt-plugin-submission.md) | OpenAI listing material, evaluations, and portal normalization |
